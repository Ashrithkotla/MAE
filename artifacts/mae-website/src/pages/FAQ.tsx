  ...
  return (
    <div data-testid={`faq-item-${faq.id}`}>
      <button
        ...
        className="flex w-full items-center justify-between text-left gap-6 px-6 py-5 hover:bg-gray-50 transition-colors"
    ...
    <main data-testid="faq-page" className="min-h-screen">
      ...
      <section className="pt-28 pb-16 bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">Frequently asked questions.</h1>
            <p className="text-lg text-gray-500 leading-relaxed">
              Everything you need to know before making your decision. Can't find an answer? Just ask us directly.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Still have a question?</h2>
          <p className="text-gray-500 mb-8">No question is too small. Reach out — we reply within 24 hours.</p>
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="https://wa.me/917286066661" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3.5 border border-gray-200 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-colors" data-testid="faq-cta-whatsapp">
