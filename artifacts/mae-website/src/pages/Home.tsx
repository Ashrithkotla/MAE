  ...
  return (
    <div className="overflow-hidden">
      <motion.div ref={ref} style={{ x }} className="flex gap-5 w-max">
        {doubled.map((t, i) => (
          <div key={i} className="w-[340px] flex-shrink-0 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
  ...
  return (
    <main>
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-white dark:bg-gray-950">
        ...
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-primary/8 dark:bg-primary/10 rounded-full blur-3xl pointer-events-none animate-pulse" style={{ animationDuration: "4s" }} />
        <div className="absolute -bottom-20 -right-20 w-[500px] h-[500px] bg-violet-500/6 dark:bg-violet-500/8 rounded-full blur-3xl pointer-events-none animate-pulse" style={{ animationDuration: "6s" }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-indigo-500/3 dark:bg-indigo-500/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-10 w-full">
          <div className="grid lg:grid-cols-2 gap-14 items-center min-h-[calc(100vh-8rem)]">
            ...
            <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.85, ease: "easeOut" }}>
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/8 dark:bg-primary/15 border border-primary/20 mb-8"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
                <span className="text-xs font-bold text-primary tracking-wide">Trusted since 2004 · Vizianagaram, AP</span>
              </motion.div>

              <h1 className="font-bold text-gray-900 dark:text-white leading-[1.03] tracking-tight mb-6">
                <span className="block text-5xl lg:text-6xl xl:text-[72px]">English fluency</span>
                <span className="block text-5xl lg:text-6xl xl:text-[72px] relative">
                ...
                <span className="block text-5xl lg:text-6xl xl:text-[72px]">everything.</span>
              </h1>

              <p className="text-lg lg:text-xl text-gray-500 dark:text-gray-400 leading-relaxed mb-10 max-w-lg">
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <Link href="/contact"
                  className="group inline-flex items-center gap-2 px-7 py-4 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition-all hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-0.5 text-base">
                  Book Free Demo
                  <ArrowRight size={17} className="group-hover:translate-x-1 transition-transform" />
                </Link>
                <a href="https://wa.me/917286066661?text=Hi! I want to know more about your English courses."
                  target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-7 py-4 border-2 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:border-[#25D366] hover:text-[#25D366] hover:bg-[#25D366]/5 transition-all text-base">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {stats.map((s) => {
                  const Icon = s.icon;
                  return (
                    <div key={s.label} className={`rounded-xl p-3.5 ${s.bg} border border-gray-100 dark:border-gray-800`}>
                      <Icon size={16} className={`${s.color} mb-2`} />
                      <div className="text-2xl font-bold text-gray-900 dark:text-white tabular-nums">
                        <AnimatedCounter target={s.target} suffix={s.suffix} />
                      </div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 font-medium mt-0.5 leading-tight">{s.label}</div>
                    </div>
                  );
                })}
              </div>
            ...
            >
              {/* Primary image */}
              <motion.div
                className="absolute top-0 right-0 w-[75%] h-[68%] rounded-3xl overflow-hidden shadow-2xl"
              ...
              {/* Secondary image */}
              <motion.div
                className="absolute bottom-0 left-0 w-[50%] h-[46%] rounded-3xl overflow-hidden shadow-xl border-4 border-white dark:border-gray-950"
                whileHover={{ scale: 1.03 }} transition={{ duration: 0.4 }}
              >
                <img src={img2} alt="Students practicing" className="w-full h-full object-cover" />
              </motion.div>

              {/* Summer classes — accent */}
              <motion.div
                className="absolute bottom-[36%] right-[20%] w-[36%] h-[28%] rounded-2xl overflow-hidden shadow-lg border-4 border-white dark:border-gray-950"
              ...
              <motion.div
                className="absolute bottom-[10%] right-3 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-3.5 border border-gray-100 dark:border-gray-700 flex items-center gap-3"
              ...
              <motion.div
                className="absolute top-3 left-3 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-3.5"
      ...
      ══════════════════════════════════════ */}
      <div className="py-4 bg-gray-50 dark:bg-gray-900 border-y border-gray-200 dark:border-gray-800 overflow-hidden">
        <InfiniteMarquee items={marqueePhrases} speed={45} />
      </div>

      {/* ══════════════════════════════════════
          PHOTO GALLERY — "Inside Our World"
      ══════════════════════════════════════ */}
      <Reveal className="py-20 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* Photo grid — 3 rows of varied sizes */}
          <motion.div variants={stagger} className="grid grid-cols-12 grid-rows-3 gap-3 h-[520px]">
            {/* Large left */}
            ...
            <motion.div variants={fadeUp} className="col-span-4 row-span-1 rounded-3xl bg-gray-900 dark:bg-gray-800 flex flex-col items-center justify-center p-6 text-center">
              ...
              <Link href="/success-stories" className="text-xs font-semibold text-primary hover:underline inline-flex items-center gap-1">
      ...
      {/* ══════════════════════════════════════
          UPCOMING BATCHES — urgency strip
      ══════════════════════════════════════ */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
            <div>
              ...
              <h2 className="text-3xl font-bold">Upcoming batches — join now.</h2>
            </div>
            <a href="tel:+917286066661" className="inline-flex items-center gap-2 px-5 py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition-colors whitespace-nowrap">
            ...
            {batches.map((b) => (
              <div key={b.batch} className={`rounded-2xl border p-5 transition-all hover:-translate-y-1 cursor-pointer ${b.urgent ? "border-red-500/40 bg-red-500/5" : "border-gray-700 bg-gray-900"}`}>
                ...
                <div className="flex items-center gap-2 text-gray-400 text-xs mb-4">
                  <MapPin size={12} /> Vizianagaram · Offline & Online
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div variants={fadeUp} className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-5 leading-tight">
                The institute that delivers results,<br /><span className="text-primary">not just promises.</span>
              </h2>
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed text-lg">Not another grammar class. A transformation program built around real speaking, real practice, and real-world outcomes — backed by 25 years of proof.</p>
            </div>
            <div className="relative h-72 lg:h-80">
              <img src={img3} alt="Students" className="w-full h-full object-cover rounded-3xl shadow-2xl" />
              <div className="absolute -bottom-5 -right-5 bg-primary rounded-2xl p-5 text-white shadow-xl shadow-primary/30">
          ...
          <motion.div variants={stagger} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <motion.div key={f.title} variants={fadeUp}
                className="group p-6 rounded-2xl border-2 border-gray-100 dark:border-gray-800 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1 transition-all cursor-pointer bg-white dark:bg-gray-950">
      ...
      {/* ══════════════════════════════════════
          TRAINER SPOTLIGHT
      ══════════════════════════════════════ */}
      <Reveal className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div variants={fadeUp} className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-950 to-[#12123a]">
            ...
            <div className="grid lg:grid-cols-5 gap-0 items-stretch">
              <div className="relative z-10 lg:col-span-3 p-10 lg:p-14 flex flex-col justify-center">
                <div className="text-xs font-bold text-primary/80 uppercase tracking-widest mb-5">Meet Your Mentor</div>
                ...
                <p className="text-gray-400 leading-relaxed mb-8 text-base">
                  In 2004, Ramesh Maharshi opened with one room and one conviction: English fluency should not be a privilege for the few. Today, more than 10,000 students call him the teacher who changed their life. He still teaches personally. He still knows every student by name.
                </p>
                ...
                <div className="flex gap-4">
                  <Link href="/about" className="inline-flex items-center gap-2 text-sm font-bold text-primary hover:text-primary/80 transition-colors">
                    Read the full story <ArrowRight size={14} />
                  </Link>
                  <Link href="/contact" className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white text-sm font-bold rounded-xl hover:bg-primary/90 transition-colors">
                    Book a Demo Class
                  </Link>
                </div>
              </div>
              ...
              return (
                <motion.div key={course.id} variants={fadeUp}>
                  <Link href={`/courses/${course.slug}`}
                    className={`group flex flex-col h-full p-7 rounded-2xl border-2 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl ${colors[i]}`}>
                    <div className={`inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest mb-4 ${accents[i]}`}>
                    ...
                    <p className="text-sm italic text-gray-500 dark:text-gray-400 mb-4">{course.tagline}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-6 flex-1">{course.description}</p>
                    <div className="flex flex-wrap gap-2 mb-6">
                      {course.features.slice(0, 3).map(f => (
                        <span key={f} className="flex items-center gap-1 text-xs px-2.5 py-1 rounded-lg bg-white/80 dark:bg-gray-800/80 text-gray-600 dark:text-gray-300 font-medium border border-gray-200 dark:border-gray-700">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white max-w-xl leading-tight">Stories louder than promises.</h2>
      ...
      ══════════════════════════════════════ */}
      <Reveal className="pb-24 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div variants={fadeUp} className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 py-20 px-8 lg:px-24">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-white/60 mb-10 max-w-lg">New batches forming soon. Limited seats per batch. Book your free demo session today.</p>
                <div className="flex flex-wrap gap-4">
                  <Link href="/contact"
                    className="group inline-flex items-center gap-2 px-8 py-4 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition-all hover:shadow-2xl hover:shadow-primary/40 hover:-translate-y-0.5 text-base">
                    Book Free Demo <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                  </Link>
                  <a href="tel:+917286066661"
                    className="inline-flex items-center gap-2 px-8 py-4 border-2 border-white/25 text-white font-semibold rounded-xl hover:border-white/50 hover:bg-white/8 transition-all text-base">
                    <Phone size={16} /> +91 7286 066 661
                  </a>
                  <a href="https://wa.me/917286066661" target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-[#25D366] text-white font-semibold rounded-xl hover:bg-[#22c55e] transition-all text-base">
